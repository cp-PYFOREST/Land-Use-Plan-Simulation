...
```{r}
limit_lu <- st_read('/Users/romero61/../../capstone/pyforest/data/optimal_mock_properties/optimal_mock_properties_50.gpkg')
...
property_results <- future_map_dfr(property_ids, function(property_id) {
  property_optimal_dims <- limit_lu[limit_lu$cat == property_id, c("width_paddock", "height_paddock", "paddock_size")]
    # debug
    #cat("Processing property_id:", property_id, "\n")
  ...
  #debug
  # if (is.null(processed_property)) {
  #   cat("Error processing property_id:", property_id, "\n")
  # } else {
  #   cat("Successfully processed property_id:", property_id, "\n")
  # }
...
```{r}
#saveRDS(property_results,"/Users/romero61/../../capstone/pyforest/data/results_5608/property_results_50.rds")


property_results_copy <- readRDS("/Users/romero61/../../capstone/pyforest/data/results_5608/property_results_50.rds")
...
```{r}
#st_write(property_results_aggregated,  "/Users/romero61/../../capstone/pyforest/data/optimal_mock_properties/optimal_lup_50.gpkg")
```
